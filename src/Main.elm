...
header model =
    wrappedRow [ spacing 10, paddingXY 15 10, htmlAttribute <| Html.Attributes.style "pointer-events" "none" ]
...
uk : Model -> Model
uk model =
    { model | zoom = 3.5, panX = -446, panY = -890 }


us : Model -> Model
us model =
    { model | zoom = 2.3, panX = -2690, panY = 265 }


ja : Model -> Model
ja model =
    { model | zoom = 3.1, panX = 6053, panY = 403 }
